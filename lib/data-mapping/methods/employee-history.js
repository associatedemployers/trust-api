  ...
  for ( var ssn in hashMap ) {
    ...
    var p = new Promise(function ( resolve, reject ) {
      Employee.findOne({ ssn: ssn }, function ( err, employee ) {
        ...
        hashMap[ ssn ].map(function ( ev ) {
          ...
          return new Promise(function ( resolve, reject ) {
            ...
            Model.find({ planNumber: ev.planNumber }, function ( err, rate ) {
              ...
              employee[ rateType.split('Rate').join('').toLowerCase() ] = planObject; // rateType.split is a bit of a quick hack
        ...
        Promise.all( hashMap[ ssn ] ).then( function (e) {
          count++;

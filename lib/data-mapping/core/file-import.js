    ...
    fs.copy(fromDir, toDir, function ( err ) {
      ...
      glob(pat, function ( err, files ) {
        ...
        Promise.reduce(files, function ( count, filePath, index, filesLength ) {
          slog(chalk.dim(index, '/', filesLength, '::', 'Beginning Work...'));
          ...
          return new Promise(function ( resolve, reject ) {
            ...
            slog(chalk.dim(index, '/', filesLength, '::', 'Creating', extension, 'file document for', identifier, '- isCompany?', isCompanyFile));
            ...
            Model.findOne( query ).exec(function ( err, doc ) {
              ...
              slog(chalk.dim(index, '/', filesLength, '::', 'Found reference'));
              ...
              file.save(function ( err, fileDoc ) {
                ...
                slog(chalk.dim(index, '/', filesLength, '::', 'Saved file document. Moving old file...'));
                ...
                fs.copy(filePath, dest, function ( err ) {
                  ...
                  slog(chalk.dim(index, '/', filesLength, '::', 'Moved & renamed old file.'));
                  ...
                  doc.save(function ( err ) {
                    ...
                    slog(chalk.dim(index, '/', filesLength, '::', 'Saved ref to doc.'));
